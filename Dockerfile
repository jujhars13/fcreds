...
ADD . $GOPATH/src/github.com/EconomistDigitalSolutions/fcreds

WORKDIR $GOPATH/src/github.com/EconomistDigitalSolutions/fcreds
...
CMD export GO111MODULE=on && \
    ...
    cd $GOPATH/src/github.com/EconomistDigitalSolutions/$NAME && \
